...
def _compute_smore(main_config, topo_config, solver_config):
  ...
  #smore_tf_solver = teavar.SmoreTFModelSolver(
  #    main_config=main_config,
  #    topo_config=topo_config,
  #    solver_config=solver_config)

  smore_multi_index_solver = teavar.SmoreMultiIndexSolver(
      main_config=main_config,
      topo_config=topo_config,
      solver_config=solver_config)

  smore_robust_solver = teavar.SmoreRobustSolver(
      main_config=main_config,
      topo_config=topo_config,
      solver_config=solver_config)

  smore_local_adjust_solver = teavar.SmoreLocalAdjustSolver(
      main_config=main_config,
      topo_config=topo_config,
      solver_config=solver_config)

  #res, solving_time = smore_local_adjust_solver.compute_max_throughput()
  res, solving_time = smore_robust_solver.compute_max_throughput()
  #res, solving_time = smore_multi_index_solver.compute_max_throughput()
  #res, solving_time = smore_tf_solver.compute_max_throughput()
  #logger.info("smore result = %s" % (res))
